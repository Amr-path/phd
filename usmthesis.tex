...
\title{Dynamic Pathfinding for Autonomous Systems: An Efficient Grid-Map Framework for Classical Search}
% Malay title of your thesis
\titlems{Pencarian Laluan Dinamik untuk Sistem Autonomi: Rangka Kerja Peta Grid yang Cekap untuk Carian Klasik}
% Year submitted
\submityear{2026}
% Month submitted
\submitmonth{January}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% MAKE SURE YOU HAVE A acknowledgement.tex FILE
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% NOTE: Uncomment and add your own publications to mybib.bib when ready
%% Then add \nociteown{yourkey1,yourkey2} with your publication keys
% \addtocontents{toc}{\protect\renewcommand\protect\cftchapfont{\protect\bfseries}}
% \nociteown{yourpublication1,yourpublication2}
