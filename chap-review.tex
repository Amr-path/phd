...
These gaps motivate the four research objectives addressed in the subsequent chapters. Chapter~\ref{chap:ils} presents the Incremental Line Search framework and adaptive corridor control mechanism (Objectives~O1 and O2). Chapter~\ref{chap:folding} develops the Folding A* algorithm for symmetric grids (Objective~O3). Chapter~5 describes the open-source planning-to-flight pipeline (Objective~O4). Chapters~6 and 7 provide experimental evaluation and conclusions.
