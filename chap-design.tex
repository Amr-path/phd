...
% Strategies to Build Corridor --- route through a shared vertical rail
\coordinate (rail) at ([xshift=0.6cm]build.east);
\draw[arrow] (base.south) |- (rail) -- ([yshift=0.15cm]build.east);
\draw[arrow] (standard.south) |- (rail |- build.east) -- (build.east);
