...
\begin{figure}[htb!]
\centering
\fbox{\parbox{0.85\textwidth}{\centering\vspace{2em}\textbf{TODO: Insert framework overview diagram showing the four pipelines (Baseline, ILS, AILS, Planning-to-Flight) and their data flow.}\vspace{2em}}}
...
\begin{figure}[htb!]
\centering
\fbox{\parbox{0.85\textwidth}{\centering\vspace{2em}\textbf{TODO: Insert preprocessing pipeline flowchart showing Steps~1--9.}\vspace{2em}}}
...
\begin{figure}[htb!]
\centering
\fbox{\parbox{0.85\textwidth}{\centering\vspace{2em}\textbf{TODO: Insert strategy-selection flowchart showing the decision logic for Base, Standard, and Predictive strategies.}\vspace{2em}}}
...
\begin{figure}[htb!]
\centering
\fbox{\parbox{0.85\textwidth}{\centering\vspace{2em}\textbf{TODO: Insert AILS four-stage architecture diagram showing: Bresenham Line $\to$ Density Estimation $\to$ Adaptive Corridor $\to$ Constrained Search (with fallback loop).}\vspace{2em}}}
